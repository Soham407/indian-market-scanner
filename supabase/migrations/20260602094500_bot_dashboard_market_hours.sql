-- Keep active dashboard jobs inside the NSE regular session.
-- Function-level market-hours guards remain the source of truth for weekends
-- and configured NSE holidays.
...
where jobname in (
  ...
  'bot-heartbeat-market-open',
  'bot-heartbeat-market-day',
  'bot-heartbeat-market-close',
  'bot-premium-decay-market-open',
  'bot-premium-decay-market-day',
  'bot-premium-decay-market-close'
);
