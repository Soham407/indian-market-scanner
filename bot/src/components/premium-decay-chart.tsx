...
export function PremiumDecayChart({
  ...
  return (
    <section className="overflow-hidden rounded-[2rem] border border-slate-200 bg-white/85 shadow-[0_30px_80px_-40px_rgba(15,23,42,0.45)] backdrop-blur">
      ...
      <div className="px-4 pb-4 pt-2 sm:px-6">
        ...
        <div className="mt-4 overflow-hidden rounded-[1.5rem] border border-slate-100 bg-gradient-to-b from-slate-50 to-white">
